...
CREATE TABLE "ScratchCode" (
    ...
    CONSTRAINT "ScratchCode_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ScratchCode_code_key" ON "ScratchCode"("code");
